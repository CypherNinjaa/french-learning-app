-- Direct SQL Upload Script for French Content
-- This script bypasses RLS by using SQL directly

-- Temporarily disable RLS for content upload
...
TRUNCATE TABLE pronunciation_words RESTART IDENTITY CASCADE;
TRUNCATE TABLE questions RESTART IDENTITY CASCADE;
TRUNCATE TABLE lesson_vocabulary RESTART IDENTITY CASCADE;
TRUNCATE TABLE lesson_grammar_rules RESTART IDENTITY CASCADE;
TRUNCATE TABLE vocabulary RESTART IDENTITY CASCADE;
TRUNCATE TABLE grammar_rules RESTART IDENTITY CASCADE;
...
-- Enable RLS for pronunciation_words
ALTER TABLE pronunciation_words ENABLE ROW LEVEL SECURITY;

-- Create policies for pronunciation_words
...
FROM levels l, modules m, lessons le, vocabulary v, grammar_rules g, pronunciation_words p, questions q;
